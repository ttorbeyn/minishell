...
//		f = 2;
//
//	data->cmds = malloc(sizeof(t_cmd) * cmd_nb);
//	data->cmds[0].av = malloc(sizeof(char*) * f + 1);
//
//	data->cmds[0].ac = f;
//	data->cmds[0].av[0] = ft_strdup(cmd);
//	if (flag)
//		data->cmds[0].av[1] = ft_strdup(flag);
//
//	envp_init(data, env);
//
//}
...
//	data->cmds = malloc(sizeof(t_cmd) * cmd_nb);
//	data->cmds[0].av = malloc(sizeof(char*) * 1 + 1);
//	data->cmds[1].av = malloc(sizeof(char*) * 2 + 1);
//
//	///CMDS
//	cmd0 = "export";
//	flag0 = "TEST=bite";
